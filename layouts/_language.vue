...
<template>
    <div class="language-switch mdc-menu-surface--anchor">
        <button class="language-switch__button u-semantic-button" @click="mdcMenu.open = true">
            <img class="language-switch__button-icon" :src="`/img/icon-flag-${currentLocale.code}.png`" :srcset="`/img/icon-flag-${currentLocale.code}@2x.png 2x`" :alt="currentLocale.name" width="24" height="24">
        </button>
        <div class="mdc-menu mdc-menu-surface" tabindex="-1">
            <div class="mdc-menu__items mdc-list" role="menu" aria-hidden="true">
                ...
                <nuxt-link class="mdc-list-item" :to="switchLocalePath(currentLocale.code)">
                    <span class="mdc-list-item__text language-switch__text">{{ currentLocale.name }}</span>
                ...
                >
                    <span class="mdc-list-item__text language-switch__text">{{ locale.name }}</span>
